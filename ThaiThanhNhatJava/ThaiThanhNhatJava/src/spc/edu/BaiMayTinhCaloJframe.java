 ...
 * @author SPC
 */
public class BaiMayTinhCaloJframe extends javax.swing.JFrame {

    /**
     * Creates new form BaiMayTinhCaloJframe
     */
    public BaiMayTinhCaloJframe() {
        initComponents();
    }
    ...
    private void jButton26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton26ActionPerformed
        ...
        StringBuilder s = new StringBuilder(jTextField1.getText());
         s.deleteCharAt(jTextField1.getText().length() - 1); // Xóa ký tự cuối cùng
         backSpace = s.toString(); // Chuyển đổi lại thành chuỗi
        jTextField1.setText(backSpace); // Cập nhật lại vào jTextField
}
    }//GEN-LAST:event_jButton26ActionPerformed

    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
        num1 = Double.parseDouble(jTextField1.getText()); // Gán giá trị từ jTextField1 cho num1
        jTextField1.setText(""); // Xóa jTextField1 nếu cần
        opr = "+";
    ...
    private void jButton35ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton35ActionPerformed
         num2 = Double.parseDouble(jTextField1.getText());
          double result = 0;
          if (opr.equals("+")) {
        result = num1 + num2; // Phép cộng
    } else if (opr.equals("-")) {
        result = num1 - num2; // Phép trừ
    } else if (opr.equals("*")) {
        result = num1 * num2; // Phép nhân
    } else if (opr.equals("/")) {
        if (num2 != 0) {
            result = num1 / num2; // Phép chia
        } else {
            jTextField1.setText("Error: Divide by zero");
            return; // Tránh chia cho 0
        }
    }

    jTextField1.setText(String.valueOf(result)); // Hiển thị kết quả
   ...
   double t = Math.cos(Double.parseDouble(jTextField1.getText())); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaiMayTinhCaloJframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaiMayTinhCaloJframe().setVisible(true);
            }
        });
    }
